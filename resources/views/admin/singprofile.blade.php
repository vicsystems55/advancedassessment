      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">{{ $user_data->name}}</h1>
            ...
            <div class="card-body">
                ...
                <div class="card">
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                    ...
                    @include('admin.singprofile.pinfo')
              ...
              <form>
                <h6 class="heading-small text-muted mb-4">User Personal Information</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                ...
                <hr class="my-4">
                <!-- Address -->
                <h6 class="heading-small text-muted mb-4">Official Data</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">

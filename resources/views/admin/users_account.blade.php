            ...
            <div class="row">
                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent p-2">
                        <div class="text-muted text-center mt-2 mb-4"><h3>{{ __('Create user Account') }}</h3></div>
                        
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        
                        <form role="form" method="POST" action="{{ route('admin.regUser') }}">
                            @csrf
